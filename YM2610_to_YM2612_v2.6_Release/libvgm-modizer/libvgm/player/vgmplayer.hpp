...
public:
	...
	// Chip visualization support: public accessor for chip device pointer
	CHIP_DEVICE* GetChipDevice(UINT8 chipType, UINT8 chipID) { return GetDevicePtr(chipType, chipID); }
