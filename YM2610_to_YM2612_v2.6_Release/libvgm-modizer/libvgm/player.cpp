...
static UINT32 masterVol = 0xC000;	// fixed point 16.16 (0.75 == 75% to prevent clipping)
...
static UINT8 StartAudioDevice(void)
{
	...
	opts->usecPerBuf = 10000;	// 10 ms per buffer (same as DirectSound default)
	opts->numBuffers = 10;		// 100 ms latency (same as DirectSound default)
